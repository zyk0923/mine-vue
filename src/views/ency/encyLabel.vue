	...
	<el-row class="warp">
		...
		<el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中" style="padding-top: 10px;">
			...
			<el-card shadow="hover" style="padding-bottom: 0px;">
				<el-col :span="24" class="toolbar" style="padding-top: 0px;">
					<el-form :inline="true" :model="filters" size="mini" style="float: left;">
						<el-form-item>
							<el-input v-model="filters.label_name" placeholder="名称" style="min-width: 240px;" @keyup.enter.native="handleSearch"></el-input>
						</el-form-item>
						<el-form-item>
			...
			<el-card shadow="hover" class="card2">
				<el-table :data="label" highlight-current-row max-height="500" size="mini" v-loading="loading"
				 @selection-change="selsChange" style="width: 100%;">>
					<el-table-column type="selection" width="55">
					</el-table-column>
					<el-table-column type="index" span="3">
					</el-table-column>
					<el-table-column prop="label_name" label="标签名称" span="6">
					</el-table-column>
				...
				<div class="block" style="float:initial;">
					<el-button-group style="float:left;">
						...
						<el-button type="danger" @click="batchdeleteObj" size="mini" :disabled="this.label.length===0">批量删除</el-button>
					</el-button-group>
			...
			<el-dialog :title="formtitle" :visible.sync="formVisible" :close-on-click-modal="false">
				<el-form :model="diaForm" label-width="80px" :rules="diaFormRules" ref="diaForm">
					<el-form-item label="标签名称" prop="label_name">
						<el-input v-model="diaForm.label_name" placeholder="必填" auto-complete="off"></el-input>
					</el-form-item>
		...
		methods: {
			...
			search: function() {
				let params = {
					...
					entity: {
						label_name: this.filters.label_name
					}
				};
				this.loading = true;
				this.searchData(this.GLOBAL.sPath.encyLabel.listPage, params).then(res => {
					this.loading = false;
			...
			addorUpdateSubmit: function() {
				this.$refs['diaForm'].validate((valid) => {
					if (valid) {
						let path = this.GLOBAL.sPath.encyLabel;
			...
			deleteObj: function(index, row) {
				this.deleteData(this.GLOBAL.sPath.encyLabel.delete, {
						id: row.id
					})
					.then(() => {
						this.search();
			...
			batchdeleteObj: function() {
				...
				this.deleteData(this.GLOBAL.sPath.encyLabel.deleteAll, this.sels.map(item => item.id))
					.then(() => {
						this.search();
					});
			},
